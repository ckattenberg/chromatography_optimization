...
class GA:
    ...
    def cal_pop_fitness(self):
        ...
        for sol_idx, sol in enumerate(self.population):
            #print("Is this working? ", sol_idx, sol)
            #print("last generation parents: ", self.last_generation_parents)
            # Check if the parent's fitness value is already calculated. If so, use it instead of calling the fitness function.
                ...
                #print("ALREADY CALCULATED: ", sol, sol_idx)
    ...
    def run(self):
        ...
        for generation in range(self.num_generations):
            ...
            runtime_per_iteration.append(total_runtime)

        #print("fitnesses last generation: ", self.last_generation_fitness)
        ...
        self.runtimes = runtime_per_iteration
